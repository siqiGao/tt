...
def template(using_entity, question):  # 使用实体id，传进来的是[name , keyid]
    ...
    if result3 != []:
        ...
        # time.sleep(6)
        result4 = bert_choose_type(result1, result2, question)
        return result4
    '''
...
def bert_choose_type(result1, result2, question):
    type_score1 = 0
    type_score2 = 0
    temp = question
    sentence1 = ""
    sentence2 = ""
    if result1:
        sentence1 = result1[0][0] + '的' + result1[0][1]
    ...
    if result2:
        ...
        relation1 = result2[0][0].split('/')[1]
        two_hop_relation = relation1 + result2[0][1]
        sentence2 = entity + '的' + relation1 + '的' + result2[0][1]
    print(sentence1, sentence2)
    score1 = simi(question, sentence1)
    score2 = simi(question, sentence2)
    if score1 < score2:
        result4 = result2
    else:
        result4 = result1
...
def answer(line):
    ...
    try:
        ...
        # print(neirong)
    q = open("answer_8_14.txt", 'a', encoding="utf-8")
